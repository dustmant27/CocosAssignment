...
Scene* PlayerWinScene::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = PlayerWinScene::create();
...
bool PlayerWinScene::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(PlayerWinScene::menuCloseCallback, this));
    ...
    auto titleSprite = Sprite::create("YouWin.png");
    ...
    auto gameButton = MenuItemImage::create("MenuButton.png", "MenuButton.png",
                                            CC_CALLBACK_1(PlayerWinScene::gameButtonCallback, this));
...
void PlayerWinScene::gameButtonCallback(Object* pSender)
{
    
    Director::getInstance()->pushScene(MainMenuScene::createScene());
}

void PlayerWinScene::menuCloseCallback(Object* pSender)
{
